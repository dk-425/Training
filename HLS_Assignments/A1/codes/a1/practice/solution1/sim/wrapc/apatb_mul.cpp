...
short* c)
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<16> *c_pc_buffer = new sc_bv<16>[1];
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: c
				{
					...
					// {
						// celement: c(15, 0)
						// {
							sc_lv<16>* c_lv0_0_0_1 = new sc_lv<16>[1];
						// }
					// }
					...
					// bitslice(15, 0)
					{
						...
						// celement: c(15, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 0; i_0 += 1)
							{
								...
								{
									c_lv0_0_0_1[hls_map_index].range(15, 0) = sc_bv<16>(c_pc_buffer[hls_map_index].range(15, 0));
									hls_map_index++;
								}
							}
						}
...
// [call_c_dut] ---------->
		...
		sc_bv<16>* c_tvout_wrapc_buffer = new sc_bv<16>[1];
