...
architecture rtl of a5b_bram_V_ram is 
...
architecture arch of a5b_bram_V is
    component a5b_bram_V_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    a5b_bram_V_ram_U :  component a5b_bram_V_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
