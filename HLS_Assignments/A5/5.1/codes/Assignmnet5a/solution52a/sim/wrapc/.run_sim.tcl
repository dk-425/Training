...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "a5a.autotvin.dat"
	set constFileTvOut       "a5a.autotvout.dat"
	set constFileHdlTvIn     "a5a.autohdltvin.dat"
	set constFileHdlTvOut    "a5a.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
