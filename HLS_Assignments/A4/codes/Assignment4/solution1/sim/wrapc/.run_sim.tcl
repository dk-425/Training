...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "cal.autotvin.dat"
	set constFileTvOut       "cal.autotvout.dat"
	set constFileHdlTvIn     "cal.autohdltvin.dat"
	set constFileHdlTvOut    "cal.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
