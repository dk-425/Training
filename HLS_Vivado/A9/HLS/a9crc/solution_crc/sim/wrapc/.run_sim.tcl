...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "crc24a.autotvin.dat"
	set constFileTvOut       "crc24a.autotvout.dat"
	set constFileHdlTvIn     "crc24a.autohdltvin.dat"
	set constFileHdlTvOut    "crc24a.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
