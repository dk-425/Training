...
set DataType0 [list "bundle" "struct bundle" $structMem0 1 0 $structParameter0 $structArgument0 $NameSpace0 $structIsPacked0]
...
set DataType1 [list "bundle" "struct bundle" $structMem1 1 0 $structParameter1 $structArgument1 $NameSpace1 $structIsPacked1]
