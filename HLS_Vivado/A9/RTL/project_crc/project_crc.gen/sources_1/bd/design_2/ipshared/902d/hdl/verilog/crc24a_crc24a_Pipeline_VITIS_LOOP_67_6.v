...
module crc24a_crc24a_Pipeline_VITIS_LOOP_67_6 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        trunc_ln3,
        icmp_ln57_lcssa,
        mux_case_01754_reload,
        conv3_i_15071757_reload,
        conv3_i_15211760_reload,
        conv3_i_15351763_reload,
        conv3_i_15491766_reload,
        conv3_i_15631769_reload,
        conv3_i_66041772_reload,
        lhs_V_1_reload,
        mux_case_85031778_reload,
        mux_case_95961781_reload,
        mux_case_105971784_reload,
        mux_case_115981787_reload,
        lhs_V_2_reload,
        lhs_V_3_reload,
        mux_case_146971796_reload,
        mux_case_157921799_reload,
        lhs_V_4_reload,
        mux_case_177941805_reload,
        mux_case_188891808_reload,
        lhs_V_5_reload,
        lhs_V_6_reload,
        mux_case_219881817_reload,
        mux_case_2210831820_reload,
        lhs_V_7_reload,
        lhs_V_8_reload,
        lhs_V_9_reload,
        lhs_V_10_reload,
        lhs_V_11_reload,
        mux_case_2814731838_reload,
        lhs_V_12_reload,
        lhs_V_13_reload,
        mux_case_3144916671847_reload,
        f_V_23_out,
        f_V_23_out_ap_vld,
        f_V_22_out,
        f_V_22_out_ap_vld,
...
output   ap_ready;
input  [4:0] trunc_ln3;
input  [0:0] icmp_ln57_lcssa;
input  [0:0] mux_case_01754_reload;
input  [0:0] conv3_i_15071757_reload;
input  [0:0] conv3_i_15211760_reload;
input  [0:0] conv3_i_15351763_reload;
input  [0:0] conv3_i_15491766_reload;
input  [0:0] conv3_i_15631769_reload;
input  [0:0] conv3_i_66041772_reload;
input  [0:0] lhs_V_1_reload;
input  [0:0] mux_case_85031778_reload;
input  [0:0] mux_case_95961781_reload;
input  [0:0] mux_case_105971784_reload;
input  [0:0] mux_case_115981787_reload;
input  [0:0] lhs_V_2_reload;
input  [0:0] lhs_V_3_reload;
input  [0:0] mux_case_146971796_reload;
input  [0:0] mux_case_157921799_reload;
input  [0:0] lhs_V_4_reload;
input  [0:0] mux_case_177941805_reload;
input  [0:0] mux_case_188891808_reload;
input  [0:0] lhs_V_5_reload;
input  [0:0] lhs_V_6_reload;
input  [0:0] mux_case_219881817_reload;
input  [0:0] mux_case_2210831820_reload;
...
input  [0:0] mux_case_2814731838_reload;
input  [0:0] lhs_V_12_reload;
input  [0:0] lhs_V_13_reload;
input  [0:0] mux_case_3144916671847_reload;
...
wire   [0:0] icmp_ln67_fu_668_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
reg   [4:0] i_2_fu_188;
wire   [4:0] add_ln67_fu_674_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        if ((icmp_ln67_fu_668_p2 == 1'd0)) begin
...
always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (icmp_ln67_fu_668_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (i_load_fu_665_p1 == 5'd10))) begin
        f_V_10_fu_232 <= f_V_24_fu_694_p34;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (icmp_ln67_fu_668_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (i_load_fu_665_p1 == 5'd11))) begin
        f_V_11_fu_236 <= f_V_24_fu_694_p34;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (icmp_ln67_fu_668_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (i_load_fu_665_p1 == 5'd12))) begin
        f_V_12_fu_240 <= f_V_24_fu_694_p34;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (icmp_ln67_fu_668_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (i_load_fu_665_p1 == 5'd13))) begin
        f_V_13_fu_244 <= f_V_24_fu_694_p34;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (icmp_ln67_fu_668_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (i_load_fu_665_p1 == 5'd14))) begin
        f_V_14_fu_248 <= f_V_24_fu_694_p34;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (icmp_ln67_fu_668_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (i_load_fu_665_p1 == 5'd15))) begin
        f_V_15_fu_252 <= f_V_24_fu_694_p34;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (icmp_ln67_fu_668_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (i_load_fu_665_p1 == 5'd16))) begin
        f_V_16_fu_256 <= f_V_24_fu_694_p34;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (icmp_ln67_fu_668_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (i_load_fu_665_p1 == 5'd17))) begin
        f_V_17_fu_260 <= f_V_24_fu_694_p34;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (icmp_ln67_fu_668_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (i_load_fu_665_p1 == 5'd18))) begin
        f_V_18_fu_264 <= f_V_24_fu_694_p34;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (icmp_ln67_fu_668_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (i_load_fu_665_p1 == 5'd19))) begin
        f_V_19_fu_268 <= f_V_24_fu_694_p34;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (icmp_ln67_fu_668_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (i_load_fu_665_p1 == 5'd1))) begin
        f_V_1_fu_196 <= f_V_24_fu_694_p34;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (icmp_ln67_fu_668_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (i_load_fu_665_p1 == 5'd20))) begin
        f_V_20_fu_272 <= f_V_24_fu_694_p34;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (icmp_ln67_fu_668_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (i_load_fu_665_p1 == 5'd21))) begin
        f_V_21_fu_276 <= f_V_24_fu_694_p34;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (icmp_ln67_fu_668_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (i_load_fu_665_p1 == 5'd22))) begin
        f_V_22_fu_280 <= f_V_24_fu_694_p34;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_state1) & ((((((((((icmp_ln67_fu_668_p2 == 1'd0) & (i_load_fu_665_p1 == 5'd30)) | ((icmp_ln67_fu_668_p2 == 1'd0) & (i_load_fu_665_p1 == 5'd31))) | ((icmp_ln67_fu_668_p2 == 1'd0) & (i_load_fu_665_p1 == 5'd29))) | ((icmp_ln67_fu_668_p2 == 1'd0) & (i_load_fu_665_p1 == 5'd28))) | ((icmp_ln67_fu_668_p2 == 1'd0) & (i_load_fu_665_p1 == 5'd27))) | ((icmp_ln67_fu_668_p2 == 1'd0) & (i_load_fu_665_p1 == 5'd26))) | ((icmp_ln67_fu_668_p2 == 1'd0) & (i_load_fu_665_p1 == 5'd25))) | ((icmp_ln67_fu_668_p2 == 1'd0) & (i_load_fu_665_p1 == 5'd24))) | ((icmp_ln67_fu_668_p2 == 1'd0) & (i_load_fu_665_p1 == 5'd23))))) begin
        f_V_23_fu_284 <= f_V_24_fu_694_p34;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (icmp_ln67_fu_668_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (i_load_fu_665_p1 == 5'd2))) begin
        f_V_2_fu_200 <= f_V_24_fu_694_p34;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (icmp_ln67_fu_668_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (i_load_fu_665_p1 == 5'd3))) begin
        f_V_3_fu_204 <= f_V_24_fu_694_p34;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (icmp_ln67_fu_668_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (i_load_fu_665_p1 == 5'd4))) begin
        f_V_4_fu_208 <= f_V_24_fu_694_p34;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (icmp_ln67_fu_668_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (i_load_fu_665_p1 == 5'd5))) begin
        f_V_5_fu_212 <= f_V_24_fu_694_p34;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (icmp_ln67_fu_668_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (i_load_fu_665_p1 == 5'd6))) begin
        f_V_6_fu_216 <= f_V_24_fu_694_p34;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (icmp_ln67_fu_668_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (i_load_fu_665_p1 == 5'd7))) begin
        f_V_7_fu_220 <= f_V_24_fu_694_p34;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (icmp_ln67_fu_668_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (i_load_fu_665_p1 == 5'd8))) begin
        f_V_8_fu_224 <= f_V_24_fu_694_p34;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (icmp_ln67_fu_668_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (i_load_fu_665_p1 == 5'd9))) begin
        f_V_9_fu_228 <= f_V_24_fu_694_p34;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (icmp_ln67_fu_668_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (i_load_fu_665_p1 == 5'd0))) begin
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (icmp_ln67_fu_668_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign add_ln67_fu_674_p2 = (ap_sig_allocacmp_i + 5'd1);

assign add_ln69_fu_680_p2 = (ap_sig_allocacmp_i + trunc_ln3);
...
assign f_V_24_fu_694_p33 = ((icmp_ln57_lcssa[0:0] == 1'b1) ? ap_sig_allocacmp_i : add_ln69_fu_680_p2);
...
assign icmp_ln67_fu_668_p2 = ((ap_sig_allocacmp_i == 5'd24) ? 1'b1 : 1'b0);

endmodule //crc24a_crc24a_Pipeline_VITIS_LOOP_67_6
