...
set id 1
set name cal_sdiv_9s_8s_9_13_1
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { a_V_TDATA { I 8 vector } a_V_TVALID { I 1 bit } a_V_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { b_V_TDATA { I 8 vector } b_V_TVALID { I 1 bit } b_V_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { c_V_TDATA { I 8 vector } c_V_TVALID { I 1 bit } c_V_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { d_V_TREADY { I 1 bit } d_V_TDATA { O 16 vector } d_V_TVALID { O 1 bit } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'd_V'"
}
}
