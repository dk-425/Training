...
module crc24a_crc24a_Pipeline_VITIS_LOOP_20_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        if ((icmp_ln20_fu_396_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (icmp_ln20_fu_396_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign add_ln20_fu_526_p2 = (ap_sig_allocacmp_i_3 + 6'd1);
...
assign icmp_ln20_fu_396_p2 = ((ap_sig_allocacmp_i_3 == 6'd32) ? 1'b1 : 1'b0);

endmodule //crc24a_crc24a_Pipeline_VITIS_LOOP_20_2
