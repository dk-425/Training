...
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/sam-admin/intelFPGA_lite/22.1std/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
mkdir -p ./libraries/new_component_0/
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/counter_tb.v"                -work new_component_0 -cdslib ./cds_libs/new_component_0.cds.lib
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/unsaved.v"                                                                                              
fi
