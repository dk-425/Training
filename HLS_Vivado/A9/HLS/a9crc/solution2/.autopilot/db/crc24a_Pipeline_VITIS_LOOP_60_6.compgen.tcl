...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename p \
    op interface \
    ports { p_address0 { O 5 vector } p_ce0 { O 1 bit } p_q0 { I 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { c_TREADY { I 1 bit } c_TDATA { O 8 vector } c_TVALID { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { last_TREADY { I 1 bit } last_TDATA { O 8 vector } last_TVALID { O 1 bit } } \
} "
} else {
