...
module crc24a_crc24a_Pipeline_VITIS_LOOP_39_5 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output  [0:0] icmp_ln39_out;
output   icmp_ln39_out_ap_vld;
output  [0:0] ap_return;

reg ap_idle;
reg startIdx_out_ap_vld;
reg[0:0] icmp_ln39_out;
reg icmp_ln39_out_ap_vld;
reg[0:0] ap_return;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1) & ((icmp_ln39_fu_344_p2 == 1'd1) | (tmp_fu_356_p34 == 1'd1)))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
        if (((icmp_ln39_fu_344_p2 == 1'd0) & (tmp_fu_356_p34 == 1'd0))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        if (((icmp_ln39_fu_344_p2 == 1'd0) & (tmp_fu_356_p34 == 1'd1))) begin
            ap_phi_mux_UnifiedRetVal_phi_fu_323_p4 = 1'd0;
        end else if ((icmp_ln39_fu_344_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
        if ((icmp_ln39_fu_344_p2 == 1'd1)) begin
            icmp_ln39_out = 1'd1;
        end else if (((icmp_ln39_fu_344_p2 == 1'd0) & (tmp_fu_356_p34 == 1'd1))) begin
            icmp_ln39_out = 1'd0;
        end else begin
            icmp_ln39_out = 'bx;
        end
...
always @ (*) begin
    if ((((icmp_ln39_fu_344_p2 == 1'd0) & (tmp_fu_356_p34 == 1'd1) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1)) | ((icmp_ln39_fu_344_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1)))) begin
        icmp_ln39_out_ap_vld = 1'b1;
    end else begin
        icmp_ln39_out_ap_vld = 1'b0;
    end
end
...
assign add_ln40_fu_350_p2 = (ap_sig_allocacmp_startIdx_1 + 6'd1);
...
assign icmp_ln39_fu_344_p2 = ((ap_sig_allocacmp_startIdx_1 == 6'd32) ? 1'b1 : 1'b0);

assign startIdx_out = empty_fu_339_p1;

endmodule //crc24a_crc24a_Pipeline_VITIS_LOOP_39_5
