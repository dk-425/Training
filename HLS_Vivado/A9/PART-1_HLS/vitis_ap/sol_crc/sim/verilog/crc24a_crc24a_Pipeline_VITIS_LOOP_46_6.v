...
module crc24a_crc24a_Pipeline_VITIS_LOOP_46_6 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln46_fu_329_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire   [63:0] zext_ln46_fu_341_p1;
reg   [4:0] i_fu_100;
wire   [4:0] add_ln46_fu_335_p2;
wire    ap_loop_init;
reg   [4:0] ap_sig_allocacmp_i_2;
wire   [0:0] tmp_1_fu_360_p34;
wire   [4:0] add_ln48_fu_346_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
        if ((icmp_ln46_fu_329_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((icmp_ln46_fu_329_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln46_fu_329_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
        temp_V_we0 = 1'b1;
    end else begin
        temp_V_we0 = 1'b0;
    end
...
assign add_ln46_fu_335_p2 = (ap_sig_allocacmp_i_2 + 5'd1);

assign add_ln48_fu_346_p2 = (ap_sig_allocacmp_i_2 + trunc_ln3);
...
assign icmp_ln46_fu_329_p2 = ((ap_sig_allocacmp_i_2 == 5'd24) ? 1'b1 : 1'b0);

assign temp_V_address0 = zext_ln46_fu_341_p1;

assign temp_V_d0 = tmp_1_fu_360_p34;

assign tmp_1_fu_360_p33 = ((icmp_ln39_lcssa[0:0] == 1'b1) ? ap_sig_allocacmp_i_2 : add_ln48_fu_346_p2);

assign zext_ln46_fu_341_p1 = ap_sig_allocacmp_i_2;

endmodule //crc24a_crc24a_Pipeline_VITIS_LOOP_46_6
