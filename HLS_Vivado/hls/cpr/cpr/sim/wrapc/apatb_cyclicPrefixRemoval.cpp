...
extern "C"
void apatb_cyclicPrefixRemoval_hw(void* __xlx_apatb_param_inpstream, void* __xlx_apatb_param_oupstream)
{
  ...
  try {
    ...
    cyclicPrefixRemoval_hw_stub_wrapper(__xlx_apatb_param_inpstream, __xlx_apatb_param_oupstream);
    port1.buffer();
