...
module crc24a_crc24a_Pipeline_VITIS_LOOP_53_6 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_state1) & ((icmp_ln53_fu_467_p2 == 1'd1) | (tmp_1_fu_479_p50 == 1'd1)))) begin
...
always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        if (((icmp_ln53_fu_467_p2 == 1'd0) & (tmp_1_fu_479_p50 == 1'd0))) begin
            startIdx_fu_138 <= add_ln55_fu_473_p2;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        if (((icmp_ln53_fu_467_p2 == 1'd0) & (tmp_1_fu_479_p50 == 1'd1))) begin
            ap_phi_mux_UnifiedRetVal_phi_fu_450_p4 = 1'd0;
        end else if ((icmp_ln53_fu_467_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        if ((icmp_ln53_fu_467_p2 == 1'd1)) begin
            icmp_ln53_out = 1'd1;
        end else if (((icmp_ln53_fu_467_p2 == 1'd0) & (tmp_1_fu_479_p50 == 1'd1))) begin
            icmp_ln53_out = 1'd0;
        end else begin
            icmp_ln53_out = 'bx;
        end
...
always @ (*) begin
    if ((((icmp_ln53_fu_467_p2 == 1'd0) & (tmp_1_fu_479_p50 == 1'd1) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_state1)) | ((icmp_ln53_fu_467_p2 == 1'd1) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_state1)))) begin
...
assign add_ln55_fu_473_p2 = (ap_sig_allocacmp_startIdx_1 + 6'd1);
...
assign icmp_ln53_fu_467_p2 = ((ap_sig_allocacmp_startIdx_1 == 6'd48) ? 1'b1 : 1'b0);

endmodule //crc24a_crc24a_Pipeline_VITIS_LOOP_53_6
