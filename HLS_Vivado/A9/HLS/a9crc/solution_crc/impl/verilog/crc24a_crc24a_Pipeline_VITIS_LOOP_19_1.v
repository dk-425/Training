...
module crc24a_crc24a_Pipeline_VITIS_LOOP_19_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
        if ((icmp_ln19_fu_166_p2 == 1'd0)) begin
...
always @ (posedge ap_clk) begin
    if (((trunc_ln779_fu_178_p1 == 3'd1) & (icmp_ln19_fu_166_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
        crc_V_1_fu_68 <= crc_V_84_fu_186_p3;
    end
end

always @ (posedge ap_clk) begin
    if (((trunc_ln779_fu_178_p1 == 3'd2) & (icmp_ln19_fu_166_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
        crc_V_2_fu_72 <= crc_V_84_fu_186_p3;
    end
end

always @ (posedge ap_clk) begin
    if (((trunc_ln779_fu_178_p1 == 3'd3) & (icmp_ln19_fu_166_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
        crc_V_3_fu_76 <= crc_V_84_fu_186_p3;
    end
end

always @ (posedge ap_clk) begin
    if (((trunc_ln779_fu_178_p1 == 3'd4) & (icmp_ln19_fu_166_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
        crc_V_4_fu_80 <= crc_V_84_fu_186_p3;
    end
end

always @ (posedge ap_clk) begin
    if (((trunc_ln779_fu_178_p1 == 3'd5) & (icmp_ln19_fu_166_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
        crc_V_5_fu_84 <= crc_V_84_fu_186_p3;
    end
end

always @ (posedge ap_clk) begin
    if (((trunc_ln779_fu_178_p1 == 3'd6) & (icmp_ln19_fu_166_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
        crc_V_6_fu_88 <= crc_V_84_fu_186_p3;
    end
end

always @ (posedge ap_clk) begin
    if (((trunc_ln779_fu_178_p1 == 3'd7) & (icmp_ln19_fu_166_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
        crc_V_7_fu_92 <= crc_V_84_fu_186_p3;
    end
end

always @ (posedge ap_clk) begin
    if (((trunc_ln779_fu_178_p1 == 3'd0) & (icmp_ln19_fu_166_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln19_fu_166_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
...
assign icmp_ln19_fu_166_p2 = ((ap_sig_allocacmp_j_1 == 4'd8) ? 1'b1 : 1'b0);
...
endmodule //crc24a_crc24a_Pipeline_VITIS_LOOP_19_1
