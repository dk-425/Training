...
module crc24a_crc24a_Pipeline_VITIS_LOOP_56_6 (
        ...
        trunc_ln3,
        icmp_ln46_lcssa,
        mux_case_01735_reload,
        conv3_i_14971738_reload,
        conv3_i_15111741_reload,
        conv3_i_15251744_reload,
        conv3_i_15391747_reload,
        conv3_i_15531750_reload,
        conv3_i_65941753_reload,
        lhs_V_1_reload,
        mux_case_84931759_reload,
        mux_case_95861762_reload,
        mux_case_105871765_reload,
        mux_case_115881768_reload,
        lhs_V_2_reload,
        lhs_V_3_reload,
        mux_case_146871777_reload,
        mux_case_157821780_reload,
        lhs_V_4_reload,
        mux_case_177841786_reload,
        mux_case_188791789_reload,
        lhs_V_5_reload,
        lhs_V_6_reload,
        mux_case_219781798_reload,
        mux_case_2210731801_reload,
        lhs_V_7_reload,
        lhs_V_8_reload,
        lhs_V_9_reload,
        lhs_V_10_reload,
        lhs_V_11_reload,
        mux_case_2814631819_reload,
        lhs_V_12_reload,
        lhs_V_13_reload,
        mux_case_3143916571828_reload,
        f_V_23_out,
        f_V_23_out_ap_vld,
        f_V_22_out,
        f_V_22_out_ap_vld,
...
input  [0:0] mux_case_01735_reload;
input  [0:0] conv3_i_14971738_reload;
input  [0:0] conv3_i_15111741_reload;
input  [0:0] conv3_i_15251744_reload;
input  [0:0] conv3_i_15391747_reload;
input  [0:0] conv3_i_15531750_reload;
input  [0:0] conv3_i_65941753_reload;
input  [0:0] lhs_V_1_reload;
input  [0:0] mux_case_84931759_reload;
input  [0:0] mux_case_95861762_reload;
input  [0:0] mux_case_105871765_reload;
input  [0:0] mux_case_115881768_reload;
input  [0:0] lhs_V_2_reload;
input  [0:0] lhs_V_3_reload;
input  [0:0] mux_case_146871777_reload;
input  [0:0] mux_case_157821780_reload;
input  [0:0] lhs_V_4_reload;
input  [0:0] mux_case_177841786_reload;
input  [0:0] mux_case_188791789_reload;
input  [0:0] lhs_V_5_reload;
input  [0:0] lhs_V_6_reload;
input  [0:0] mux_case_219781798_reload;
input  [0:0] mux_case_2210731801_reload;
...
input  [0:0] mux_case_2814631819_reload;
input  [0:0] lhs_V_12_reload;
input  [0:0] lhs_V_13_reload;
input  [0:0] mux_case_3143916571828_reload;
...
crc24a_mux_325_1_1_1 #(
    ...
    .dout_WIDTH( 1 ))
mux_325_1_1_1_U136(
    .din0(mux_case_01735_reload),
    .din1(conv3_i_14971738_reload),
    .din2(conv3_i_15111741_reload),
    .din3(conv3_i_15251744_reload),
    .din4(conv3_i_15391747_reload),
    .din5(conv3_i_15531750_reload),
    .din6(conv3_i_65941753_reload),
    .din7(lhs_V_1_reload),
    .din8(mux_case_84931759_reload),
    .din9(mux_case_95861762_reload),
    .din10(mux_case_105871765_reload),
    .din11(mux_case_115881768_reload),
    .din12(lhs_V_2_reload),
    .din13(lhs_V_3_reload),
    .din14(mux_case_146871777_reload),
    .din15(mux_case_157821780_reload),
    .din16(lhs_V_4_reload),
    .din17(mux_case_177841786_reload),
    .din18(mux_case_188791789_reload),
    .din19(lhs_V_5_reload),
    .din20(lhs_V_6_reload),
    .din21(mux_case_219781798_reload),
    .din22(mux_case_2210731801_reload),
    .din23(lhs_V_7_reload),
    .din24(lhs_V_8_reload),
    .din25(lhs_V_9_reload),
    .din26(lhs_V_10_reload),
    .din27(lhs_V_11_reload),
    .din28(mux_case_2814631819_reload),
    .din29(lhs_V_12_reload),
    .din30(lhs_V_13_reload),
    .din31(mux_case_3143916571828_reload),
