// ==============================================================
// File generated on Wed Mar 15 11:00:35 IST 2023
...
`define AUTOTB_TVIN_a  "./c.mul.autotvin_a.dat"
`define AUTOTB_TVIN_b  "./c.mul.autotvin_b.dat"
`define AUTOTB_TVIN_a_out_wrapc  "./rtl.mul.autotvin_a.dat"
`define AUTOTB_TVIN_b_out_wrapc  "./rtl.mul.autotvin_b.dat"
`define AUTOTB_TVOUT_c  "./c.mul.autotvout_c.dat"
`define AUTOTB_TVOUT_c_out_wrapc  "./impl_rtl.mul.autotvout_c.dat"
module `AUTOTB_TOP;
...
initial begin : write_file_process_c
    ...
    while (transaction_idx != AUTOTB_TRANSACTION_NUM) begin
        ...
        if(AESL_REG_c_ap_vld)  begin
          $fdisplay(fp,"0x%x", AESL_REG_c);
        AESL_REG_c_ap_vld = 0;
        end
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.mul.autotvout_c.dat", "r");
    fp2 = $fopen("./impl_rtl.mul.autotvout_c.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.mul.autotvout_c.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.mul.autotvout_c.dat\"!");
    else begin
        $display("Comparing rtl.mul.autotvout_c.dat with impl_rtl.mul.autotvout_c.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
