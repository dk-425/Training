...
# Design libraries
design_libs=(simprims_ver xlconstant_v1_1_7 xil_defaultlib)
...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../vivado_a9.gen/sources_1/bd/design_1/ipshared/ebd1/hdl/verilog" \
       +incdir+"../../../../vivado_a9.gen/sources_1/bd/design_1/ipshared/ebd1/hdl/verilog" \
       -input simulate.do
}
