...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "gen.autotvin.dat"
	set constFileTvOut       "gen.autotvout.dat"
	set constFileHdlTvIn     "gen.autohdltvin.dat"
	set constFileHdlTvOut    "gen.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
