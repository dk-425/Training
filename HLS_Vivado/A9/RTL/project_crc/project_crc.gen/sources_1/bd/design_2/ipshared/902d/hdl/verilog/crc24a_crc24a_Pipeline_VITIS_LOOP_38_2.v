...
module crc24a_crc24a_Pipeline_VITIS_LOOP_38_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln38_fu_396_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
reg   [5:0] i_fu_120;
wire   [5:0] add_ln38_fu_526_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        if ((icmp_ln38_fu_396_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (icmp_ln38_fu_396_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign add_ln38_fu_526_p2 = (ap_sig_allocacmp_i_5 + 6'd1);
...
assign icmp_ln38_fu_396_p2 = ((ap_sig_allocacmp_i_5 == 6'd32) ? 1'b1 : 1'b0);
...
endmodule //crc24a_crc24a_Pipeline_VITIS_LOOP_38_2
