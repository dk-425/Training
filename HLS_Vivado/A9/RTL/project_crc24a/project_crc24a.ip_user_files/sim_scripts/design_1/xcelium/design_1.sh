...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../project_crc24a.gen/sources_1/bd/design_1/ipshared/4279/hdl/verilog" \
       +incdir+"../../../../project_crc24a.gen/sources_1/bd/design_1/ipshared/4279/hdl/verilog" \
       -input simulate.do
}
