...
`define TV_OUT_output_r_TDATA "../tv/rtldatafile/rtl.crc24a.autotvout_output_r.dat"
...
module AESL_axi_s_output_r (
    input clk,
    input reset,
    input [8 - 1:0] TRAN_output_r_TDATA,
    ...
    reg [8 - 1:0] output_r_TDATA_write_data;
    reg output_r_TDATA_read_en;
    wire [8 - 1:0] output_r_TDATA_read_data;
    
    fifo #(4, 8) fifo_output_r_TDATA (
        .reset(1'b0),
        .write_clock(clk),
