...
wire   [0:0] icmp_ln43_fu_394_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
reg   [5:0] i_1_fu_118;
wire   [5:0] add_ln43_fu_520_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        if ((icmp_ln43_fu_394_p2 == 1'd0)) begin
            i_1_fu_118 <= add_ln43_fu_520_p2;
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (icmp_ln43_fu_394_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign add_ln43_fu_520_p2 = (ap_sig_allocacmp_i + 6'd1);
...
assign icmp_ln43_fu_394_p2 = ((ap_sig_allocacmp_i == 6'd48) ? 1'b1 : 1'b0);
