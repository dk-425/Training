...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../project_81.gen/sources_1/bd/design_1/ipshared/2bcd/hdl/verilog" \
       +incdir+"$ref_dir/../../../../project_81.gen/sources_1/bd/design_1/ipshared/bf9b/hdl/verilog" \
       +incdir+"../../../../project_81.gen/sources_1/bd/design_1/ipshared/2bcd/hdl/verilog" \
       +incdir+"../../../../project_81.gen/sources_1/bd/design_1/ipshared/bf9b/hdl/verilog" \
       -input simulate.do
}
