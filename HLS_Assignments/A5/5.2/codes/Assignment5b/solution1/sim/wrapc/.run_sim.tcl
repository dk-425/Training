...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "a5b.autotvin.dat"
	set constFileTvOut       "a5b.autotvout.dat"
	set constFileHdlTvIn     "a5b.autohdltvin.dat"
	set constFileHdlTvOut    "a5b.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
