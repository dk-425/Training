...
module crc24a_crc24a_Pipeline_VITIS_LOOP_52_5 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln52_fu_247_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire   [63:0] zext_ln52_fu_259_p1;
reg   [4:0] i_fu_78;
wire   [4:0] add_ln52_fu_253_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
        if ((icmp_ln52_fu_247_p2 == 1'd0)) begin
            i_fu_78 <= add_ln52_fu_253_p2;
...
always @ (*) begin
    if (((icmp_ln52_fu_247_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln52_fu_247_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
        p_we0 = 1'b1;
    end else begin
        p_we0 = 1'b0;
    end
...
assign add_ln52_fu_253_p2 = (ap_sig_allocacmp_i_2 + 5'd1);
...
assign icmp_ln52_fu_247_p2 = ((ap_sig_allocacmp_i_2 == 5'd24) ? 1'b1 : 1'b0);

assign p_address0 = zext_ln52_fu_259_p1;

assign p_d0 = tmp_2_fu_264_p26;

assign zext_ln52_fu_259_p1 = ap_sig_allocacmp_i_2;

endmodule //crc24a_crc24a_Pipeline_VITIS_LOOP_52_5
