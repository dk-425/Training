...
entity crc24a_crc24a_Pipeline_VITIS_LOOP_49_5 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of crc24a_crc24a_Pipeline_VITIS_LOOP_49_5 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln49_fu_459_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_condition_exit_pp0_iter0_stage0 : STD_LOGIC;
    signal ap_loop_exit_ready : STD_LOGIC;
    signal ap_ready_int : STD_LOGIC;
    signal i_1_reg_664 : STD_LOGIC_VECTOR (4 downto 0);
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal storemerge_fu_637_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal storemerge_reg_672 : STD_LOGIC_VECTOR (0 downto 0);
    signal zext_ln49_fu_650_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal i_fu_134 : STD_LOGIC_VECTOR (4 downto 0);
    signal add_ln49_fu_465_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_i_1 : STD_LOGIC_VECTOR (4 downto 0);
    signal zext_ln52_fu_471_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_3_fu_535_p49 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_2_fu_475_p26 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_3_fu_535_p50 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    mux_245_1_1_1_U200 : component crc24a_mux_245_1_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    mux_486_1_1_1_U201 : component crc24a_mux_486_1_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln49_fu_459_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln49_fu_459_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
    ...
    add_ln49_fu_465_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_1) + unsigned(ap_const_lv5_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln49_fu_459_p2)
    begin
        if (((icmp_ln49_fu_459_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    icmp_ln49_fu_459_p2 <= "1" when (ap_sig_allocacmp_i_1 = ap_const_lv5_18) else "0";
    p_address0 <= zext_ln49_fu_650_p1(5 - 1 downto 0);
    ...
    storemerge_fu_637_p3 <= 
        tmp_2_fu_475_p26 when (icmp_ln45_lcssa(0) = '1') else 
        tmp_3_fu_535_p50;
    tmp_3_fu_535_p49 <= std_logic_vector(unsigned(zext_ln52_fu_471_p1) + unsigned(startIdx_reload));
    zext_ln49_fu_650_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_1_reg_664),64));
    zext_ln52_fu_471_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_1),6));
end behav;
