...
#define WRAPC_STREAM_SIZE_OUT_gst "../tv/stream_size/stream_size_out_gst.dat"
#define WRAPC_STREAM_EGRESS_STATUS_gst "../tv/stream_size/stream_egress_status_gst.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_gst "../tv/rtldatafile/rtl.gen.autotvout_gst.dat"
...
extern "C"
void gen_hw_stub_wrapper(void*);

extern "C"
void apatb_gen_hw(void* __xlx_apatb_param_gst)
{
  static hls::sim::Stream<hls::sim::Byte<8>> port0 {
    .width = 64,
    .name = "gst",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_gst),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_gst),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_gst),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_gst),
#endif
  };
  port0.param = (hls::stream<hls::sim::Byte<8>>*)__xlx_apatb_param_gst;
  port0.hasWrite = true;
  ...
  try {
    ...
    gen_hw_stub_wrapper(__xlx_apatb_param_gst);
    port0.buffer();
