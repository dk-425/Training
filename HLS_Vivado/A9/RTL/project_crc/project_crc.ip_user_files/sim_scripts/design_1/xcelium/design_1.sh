...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../project_crc.gen/sources_1/bd/design_1/ipshared/d00b/hdl/verilog" \
       +incdir+"$ref_dir/../../../../project_crc.gen/sources_1/bd/design_1/ipshared/a7eb/hdl/verilog" \
       +incdir+"../../../../project_crc.gen/sources_1/bd/design_1/ipshared/d00b/hdl/verilog" \
       +incdir+"../../../../project_crc.gen/sources_1/bd/design_1/ipshared/a7eb/hdl/verilog" \
       -input simulate.do
}
