...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename oput_V_3 \
    op interface \
    ports { oput_V_3_address0 { O 8 vector } oput_V_3_ce0 { O 1 bit } oput_V_3_we0 { O 1 bit } oput_V_3_d0 { O 1 vector } oput_V_3_address1 { O 8 vector } oput_V_3_ce1 { O 1 bit } oput_V_3_we1 { O 1 bit } oput_V_3_d1 { O 1 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'oput_V_3'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename oput_V_2 \
    op interface \
    ports { oput_V_2_address0 { O 8 vector } oput_V_2_ce0 { O 1 bit } oput_V_2_we0 { O 1 bit } oput_V_2_d0 { O 1 vector } oput_V_2_address1 { O 8 vector } oput_V_2_ce1 { O 1 bit } oput_V_2_we1 { O 1 bit } oput_V_2_d1 { O 1 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'oput_V_2'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename oput_V_1 \
    op interface \
    ports { oput_V_1_address0 { O 8 vector } oput_V_1_ce0 { O 1 bit } oput_V_1_we0 { O 1 bit } oput_V_1_d0 { O 1 vector } oput_V_1_address1 { O 8 vector } oput_V_1_ce1 { O 1 bit } oput_V_1_we1 { O 1 bit } oput_V_1_d1 { O 1 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'oput_V_1'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename oput_V \
    op interface \
    ports { oput_V_address0 { O 8 vector } oput_V_ce0 { O 1 bit } oput_V_we0 { O 1 bit } oput_V_d0 { O 1 vector } oput_V_address1 { O 8 vector } oput_V_ce1 { O 1 bit } oput_V_we1 { O 1 bit } oput_V_d1 { O 1 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'oput_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { input_r_TVALID { I 1 bit } input_r_TDATA { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { input_r_TKEEP { I 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { input_r_TSTRB { I 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { input_r_TREADY { O 1 bit } input_r_TLAST { I 1 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_d_last_V_out \
    op interface \
    ports { d_last_V_out { O 1 vector } d_last_V_out_ap_vld { O 1 bit } } \
} "
}
