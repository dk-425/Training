...
__attribute__((sdx_kernel("crc24a", 0))) void crc24a(hls::stream<data>& input, hls::stream<data>& output);
# 2 "pract.cpp" 2



__attribute__((sdx_kernel("crc24a", 0))) void crc24a(hls::stream<data>& input, hls::stream<data>& output) {
#line 15 "/home/sam-admin/Desktop/iith/Module-2/sampractrice/hlspract/practsam/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=crc24a
# 5 "pract.cpp"

#line 6 "/home/sam-admin/Desktop/iith/Module-2/sampractrice/hlspract/practsam/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=crc24a
# 5 "pract.cpp"
...
loop3: for (int i = 0; i < u + 25 - 1; i++) {
#pragma HLS PIPELINE II=1
 crc[i] = (i < u) ? crc[i] : v;
  rtc[i] = (i < u) ? crc[i] : v;
 }

loop4: for (int i = 0; i <= z - 25; i++) {
#pragma HLS PIPELINE II=1
 if (crc[i] == 1 && last == 1) {
  loop5: for (int j = 0; j < 25; j++) {
#pragma HLS UNROLL
 int k = i + j;
