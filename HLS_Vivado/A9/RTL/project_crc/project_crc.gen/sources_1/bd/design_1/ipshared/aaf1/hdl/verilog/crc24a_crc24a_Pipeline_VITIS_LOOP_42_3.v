...
module crc24a_crc24a_Pipeline_VITIS_LOOP_42_3 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        if ((icmp_ln42_fu_394_p2 == 1'd0)) begin
            i_1_fu_118 <= add_ln42_fu_520_p2;
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (icmp_ln42_fu_394_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign add_ln42_fu_520_p2 = (ap_sig_allocacmp_i + 6'd1);
...
assign icmp_ln42_fu_394_p2 = ((ap_sig_allocacmp_i == 6'd48) ? 1'b1 : 1'b0);
...
endmodule //crc24a_crc24a_Pipeline_VITIS_LOOP_42_3
