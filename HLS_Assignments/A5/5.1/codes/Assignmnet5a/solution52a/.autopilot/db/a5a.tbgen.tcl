...
set ArgLastReadFirstWriteLatency {
	a5a {
		...
		output_V_data_0_V {Type O LastRead -1 FirstWrite 2}
		output_V_data_1_V {Type O LastRead -1 FirstWrite 2}
		output_V_data_2_V {Type O LastRead -1 FirstWrite 2}
		output_V_data_3_V {Type O LastRead -1 FirstWrite 2}
		output_V_data_4_V {Type O LastRead -1 FirstWrite 2}
		output_V_data_5_V {Type O LastRead -1 FirstWrite 2}
		output_V_data_6_V {Type O LastRead -1 FirstWrite 2}
		output_V_data_7_V {Type O LastRead -1 FirstWrite 2}
