...
<h3> 
<button ontouchstart="window.location = 'http://'+location.hostname+'/front'" ontouchend="window.location = 'http://'+location.hostname+'/stop'">&#8593</button>
</h3>
<button onclick="window.location = 'http://'+location.hostname+'/left'" ontouchend="window.location = 'http://'+location.hostname+'/stop'">&#8592</button>
<button onclick="window.location = 'http://'+location.hostname+'/right'" ontouchend="window.location = 'http://'+location.hostname+'/stop'">&#8594</button>
<h3>
<button onclick="window.location = 'http://'+location.hostname+'/back'" ontouchend="window.location = 'http://'+location.hostname+'/stop'">&#8595</button>
</h3>
