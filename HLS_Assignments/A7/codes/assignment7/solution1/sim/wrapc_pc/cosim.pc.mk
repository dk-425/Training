...
$(ObjDir)/firTB.cpp_pre.cpp.tb.o : firTB.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling firTB.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/firFloat.cpp_pre.cpp.tb.o : firFloat.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling firFloat.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/firFixed.cpp_pre.cpp.tb.o : firFixed.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling firFixed.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
