...
#define WRAPC_STREAM_SIZE_OUT_z "../tv/stream_size/stream_size_out_z.dat"
#define WRAPC_STREAM_EGRESS_STATUS_z "../tv/stream_size/stream_egress_status_z.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_oupstream "../tv/rtldatafile/rtl.cyclicPrefixRemoval.autotvout_oupstream.dat"
#define AUTOTB_TVOUT_PC_z "../tv/rtldatafile/rtl.cyclicPrefixRemoval.autotvout_z.dat"
...
extern "C"
void cyclicPrefixRemoval_hw_stub_wrapper(void*, void*, void*);

extern "C"
void apatb_cyclicPrefixRemoval_hw(void* __xlx_apatb_param_inpstream, void* __xlx_apatb_param_oupstream, void* __xlx_apatb_param_z)
{
...
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_z),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_z),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_z),
#endif
  };
  port2.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_z;
  port2.hasWrite = true;
