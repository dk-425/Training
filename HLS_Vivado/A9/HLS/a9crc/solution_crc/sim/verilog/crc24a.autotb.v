...
`define AUTOTB_DUT      crc24a
`define AUTOTB_DUT_INST AESL_inst_crc24a
`define AUTOTB_TOP      apatb_crc24a_top
`define AUTOTB_LAT_RESULT_FILE "crc24a.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "crc24a.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_crc24a_top
...
assign input_r_ready = input_r_ready_reg | ready_initial;
