...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_96)) begin
        if ((icmp_ln15_fu_65_p2 == 1'd0)) begin
            i_fu_46 <= add_ln15_fu_71_p2;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln15_fu_65_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_reg_199 <= tmp_fu_77_p50;
    end
end

always @ (*) begin
    if (((icmp_ln15_fu_65_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln15_fu_71_p2 = (ap_sig_allocacmp_i_1 + 6'd1);
...
assign icmp_ln15_fu_65_p2 = ((ap_sig_allocacmp_i_1 == 6'd48) ? 1'b1 : 1'b0);
