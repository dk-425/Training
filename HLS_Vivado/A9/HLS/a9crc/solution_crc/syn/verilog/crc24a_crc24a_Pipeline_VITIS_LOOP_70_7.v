...
wire   [0:0] icmp_ln72_fu_342_p2;
reg   [7:0] p_Result_1_fu_428_p4;
wire   [0:0] tmp_5_fu_438_p3;
wire   [0:0] or_ln75_fu_478_p2;
...
always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        if ((icmp_ln70_fu_308_p2 == 1'd0)) begin
...
always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (icmp_ln70_fu_308_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (icmp_ln70_fu_308_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign add_ln70_fu_314_p2 = (ap_sig_allocacmp_i_1 + 5'd1);
...
assign g_V_1_fu_470_p3 = ((icmp_ln72_fu_342_p2[0:0] == 1'b1) ? p_Result_1_fu_428_p4 : p_Val2_s_fu_102);

assign g_V_2_out = p_Val2_s_fu_102;

assign h_V_1_fu_484_p3 = ((or_ln75_fu_478_p2[0:0] == 1'b1) ? p_Val2_1_fu_106 : p_Result_2_fu_450_p4);

assign h_V_2_out = p_Val2_1_fu_106;

assign icmp_ln70_fu_308_p2 = ((ap_sig_allocacmp_i_1 == 5'd24) ? 1'b1 : 1'b0);

assign icmp_ln72_fu_342_p2 = ((tmp_fu_332_p4 == 2'd0) ? 1'b1 : 1'b0);

assign m_V_1_fu_492_p3 = ((tmp_5_fu_438_p3[0:0] == 1'b1) ? p_Result_3_fu_460_p4 : p_Val2_2_fu_110);

assign m_V_2_out = p_Val2_2_fu_110;

assign o_V_1_fu_500_p3 = ((icmp_ln72_fu_342_p2[0:0] == 1'b1) ? p_Result_s_fu_418_p4 : p_Val2_3_fu_114);

assign o_V_2_out = p_Val2_3_fu_114;

assign or_ln75_fu_478_p2 = (tmp_5_fu_438_p3 | icmp_ln72_fu_342_p2);
