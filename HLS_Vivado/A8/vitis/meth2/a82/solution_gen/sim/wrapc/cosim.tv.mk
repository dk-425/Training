...
$(ObjDir)/cpt_tb.cpp_pre.cpp.tb.o : cpt_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling cpt_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/datagen.cpp_pre.cpp.tb.o : datagen.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling datagen.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/cpr.cpp_pre.cpp.tb.o : cpr.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling cpr.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
