# ==============================================================
# File generated on Wed Mar 15 14:57:33 IST 2023
...
$(ObjDir)/a1_tb.c_pre.c.tb.o : a1_tb.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) a1_tb.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/a1.c_pre.c.tb.o : a1.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) a1.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
