...
entity binaryDivision_binaryDivision_Pipeline_VITIS_LOOP_43_5 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of binaryDivision_binaryDivision_Pipeline_VITIS_LOOP_43_5 is 
...
attribute shreg_extract : string;
    ...
    signal tmp_1_fu_466_p50 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln43_fu_454_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_condition_exit_pp0_iter0_stage0 : STD_LOGIC;
    signal ap_loop_exit_ready : STD_LOGIC;
    signal ap_ready_int : STD_LOGIC;
    signal ap_phi_mux_UnifiedRetVal_phi_fu_437_p4 : STD_LOGIC_VECTOR (0 downto 0);
    signal startIdx_fu_134 : STD_LOGIC_VECTOR (5 downto 0);
    signal add_ln45_fu_460_p2 : STD_LOGIC_VECTOR (5 downto 0);
...
begin
    mux_486_1_1_1_U175 : component binaryDivision_mux_486_1_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1) and ((icmp_ln43_fu_454_p2 = ap_const_lv1_1) or (tmp_1_fu_466_p50 = ap_const_lv1_1)))) then 
    ...
    startIdx_fu_134_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                if (((icmp_ln43_fu_454_p2 = ap_const_lv1_0) and (tmp_1_fu_466_p50 = ap_const_lv1_0))) then 
                    startIdx_fu_134 <= add_ln45_fu_460_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    startIdx_fu_134 <= ap_const_lv6_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    add_ln45_fu_460_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_startIdx_1) + unsigned(ap_const_lv6_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_state1, tmp_1_fu_466_p50, icmp_ln43_fu_454_p2, ap_start_int)
    begin
        if (((ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1) and ((icmp_ln43_fu_454_p2 = ap_const_lv1_1) or (tmp_1_fu_466_p50 = ap_const_lv1_1)))) then 
    ...
    ap_phi_mux_UnifiedRetVal_phi_fu_437_p4_assign_proc : process(ap_CS_fsm_state1, tmp_1_fu_466_p50, icmp_ln43_fu_454_p2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
            if (((icmp_ln43_fu_454_p2 = ap_const_lv1_0) and (tmp_1_fu_466_p50 = ap_const_lv1_1))) then 
                ap_phi_mux_UnifiedRetVal_phi_fu_437_p4 <= ap_const_lv1_0;
            elsif ((icmp_ln43_fu_454_p2 = ap_const_lv1_1)) then 
                ap_phi_mux_UnifiedRetVal_phi_fu_437_p4 <= ap_const_lv1_1;
            else 
                ap_phi_mux_UnifiedRetVal_phi_fu_437_p4 <= "X";
            end if;
        else 
            ap_phi_mux_UnifiedRetVal_phi_fu_437_p4 <= "X";
        end if; 
    ...
    ap_return_assign_proc : process(ap_CS_fsm_state1, tmp_1_fu_466_p50, icmp_ln43_fu_454_p2, ap_phi_mux_UnifiedRetVal_phi_fu_437_p4, ap_return_preg, ap_start_int)
    begin
        if (((ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1) and ((icmp_ln43_fu_454_p2 = ap_const_lv1_1) or (tmp_1_fu_466_p50 = ap_const_lv1_1)))) then 
    ...
    ap_sig_allocacmp_startIdx_1_assign_proc : process(ap_CS_fsm_state1, startIdx_fu_134, ap_loop_init)
    begin
    ...
    icmp_ln43_fu_454_p2 <= "1" when (ap_sig_allocacmp_startIdx_1 = ap_const_lv6_30) else "0";

    startIdx_out_assign_proc : process(ap_CS_fsm_state1, tmp_1_fu_466_p50, icmp_ln43_fu_454_p2, ap_sig_allocacmp_startIdx_1, ap_start_int)
    begin
        if (((ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
            if ((icmp_ln43_fu_454_p2 = ap_const_lv1_1)) then 
                startIdx_out <= ap_const_lv6_30;
            elsif (((icmp_ln43_fu_454_p2 = ap_const_lv1_0) and (tmp_1_fu_466_p50 = ap_const_lv1_1))) then 
    ...
    startIdx_out_ap_vld_assign_proc : process(ap_CS_fsm_state1, tmp_1_fu_466_p50, icmp_ln43_fu_454_p2, ap_start_int)
    begin
        if ((((icmp_ln43_fu_454_p2 = ap_const_lv1_0) and (tmp_1_fu_466_p50 = ap_const_lv1_1) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1)) or ((icmp_ln43_fu_454_p2 = ap_const_lv1_1) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1)))) then 
