...
mul::mul(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sc_trace(mVcdFile, tmp_fu_43_p0, "tmp_fu_43_p0");
...
void mul::thread_c() {
    c = esl_sext<64,32>(tmp_fu_43_p2.read());
}

void mul::thread_tmp_fu_43_p0() {
    tmp_fu_43_p0 = b.read();
}

void mul::thread_tmp_fu_43_p1() {
    tmp_fu_43_p1 = a.read();
}

void mul::thread_tmp_fu_43_p2() {
    tmp_fu_43_p2 = (!tmp_fu_43_p0.read().is_01() || !tmp_fu_43_p1.read().is_01())? sc_lv<32>(): sc_bigint<32>(tmp_fu_43_p0.read()) * sc_bigint<32>(tmp_fu_43_p1.read());
}
