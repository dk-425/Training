...
module design_1
  ...
  wire ap_clk_0_1;
  wire ap_rst_n_0_1;
  wire [63:0]crc24a_0_c_TDATA;
  wire crc24a_0_c_TVALID;
  wire [7:0]crc24a_0_last_TDATA;
  wire crc24a_0_last_TVALID;
  wire [63:0]gen_0_a_TDATA;
  wire gen_0_a_TREADY;
  wire gen_0_a_TVALID;

  assign ap_clk_0_1 = ap_clk_0;
  assign ap_rst_n_0_1 = ap_rst_n_0;
  assign c_TDATA_0[63:0] = crc24a_0_c_TDATA;
  assign c_TVALID_0 = crc24a_0_c_TVALID;
  assign last_TDATA_0[7:0] = crc24a_0_last_TDATA;
  assign last_TVALID_0 = crc24a_0_last_TVALID;
  design_1_crc24a_0_0 crc24a_0
       (.a_TDATA(gen_0_a_TDATA),
        .a_TREADY(gen_0_a_TREADY),
        .a_TVALID(gen_0_a_TVALID),
        .ap_clk(ap_clk_0_1),
        ...
        .last_TVALID(crc24a_0_last_TVALID));
  design_1_gen_0_1 gen_0
       (.a_TDATA(gen_0_a_TDATA),
        .a_TREADY(gen_0_a_TREADY),
        .a_TVALID(gen_0_a_TVALID),
        .ap_clk(ap_clk_0_1),
