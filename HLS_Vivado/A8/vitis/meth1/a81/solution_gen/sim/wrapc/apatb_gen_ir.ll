; ModuleID = '/home/sam-admin/git/Training/HLS_Vivado/A8/vitis/meth1/a81/solution_gen/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_gen_ir(%"class.hls::stream<std::complex<float>, 0>"* noalias nocapture nonnull dereferenceable(8) %gst) local_unnamed_addr #1 {
entry:
  %gst_copy = alloca %"class.hls::stream<std::complex<float>, 0>", align 512
  call void @llvm.sideeffect() #7 [ "stream_interface"(%"class.hls::stream<std::complex<float>, 0>"* %gst_copy, i32 0) ]
  call fastcc void @copy_in(%"class.hls::stream<std::complex<float>, 0>"* nonnull %gst, %"class.hls::stream<std::complex<float>, 0>"* nonnull align 512 %gst_copy)
  call void @apatb_gen_hw(%"class.hls::stream<std::complex<float>, 0>"* %gst_copy)
  call void @copy_back(%"class.hls::stream<std::complex<float>, 0>"* %gst, %"class.hls::stream<std::complex<float>, 0>"* %gst_copy)
  ret void
}

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_in(%"class.hls::stream<std::complex<float>, 0>"* noalias, %"class.hls::stream<std::complex<float>, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #2 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @copy_out(%"class.hls::stream<std::complex<float>, 0>"* noalias, %"class.hls::stream<std::complex<float>, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #5 {
entry:
...
declare void @apatb_gen_hw(%"class.hls::stream<std::complex<float>, 0>"*)

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_back(%"class.hls::stream<std::complex<float>, 0>"* noalias, %"class.hls::stream<std::complex<float>, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #5 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<std::complex<float>, 0>"(%"class.hls::stream<std::complex<float>, 0>"* %0, %"class.hls::stream<std::complex<float>, 0>"* align 512 %1)
  ret void
}

define void @gen_hw_stub_wrapper(%"class.hls::stream<std::complex<float>, 0>"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream<std::complex<float>, 0>"* null, %"class.hls::stream<std::complex<float>, 0>"* %0)
  call void @gen_hw_stub(%"class.hls::stream<std::complex<float>, 0>"* %0)
  call void @copy_in(%"class.hls::stream<std::complex<float>, 0>"* null, %"class.hls::stream<std::complex<float>, 0>"* %0)
  ret void
}

declare void @gen_hw_stub(%"class.hls::stream<std::complex<float>, 0>"*)
