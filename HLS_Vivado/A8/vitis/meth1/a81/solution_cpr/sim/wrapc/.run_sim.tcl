...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "cyclicPrefixRemoval.autotvin.dat"
	set constFileTvOut       "cyclicPrefixRemoval.autotvout.dat"
	set constFileHdlTvIn     "cyclicPrefixRemoval.autohdltvin.dat"
	set constFileHdlTvOut    "cyclicPrefixRemoval.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
