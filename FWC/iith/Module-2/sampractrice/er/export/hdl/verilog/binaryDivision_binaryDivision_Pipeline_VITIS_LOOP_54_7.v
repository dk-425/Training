...
module binaryDivision_binaryDivision_Pipeline_VITIS_LOOP_54_7 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [63:0] zext_ln54_fu_578_p1;
wire    ap_block_pp0_stage0;
reg   [4:0] i_fu_130;
wire   [4:0] add_ln54_fu_455_p2;
wire    ap_loop_init;
reg   [4:0] ap_sig_allocacmp_i_2;
wire   [5:0] zext_ln56_fu_461_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln54_fu_449_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln54_fu_449_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_3_reg_597 <= tmp_3_fu_471_p50;
    end
end

always @ (*) begin
    if (((icmp_ln54_fu_449_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln54_fu_455_p2 = (ap_sig_allocacmp_i_2 + 5'd1);
...
assign icmp_ln54_fu_449_p2 = ((ap_sig_allocacmp_i_2 == 5'd24) ? 1'b1 : 1'b0);

assign p_address0 = zext_ln54_fu_578_p1;

assign p_d0 = tmp_3_reg_597;

assign tmp_3_fu_471_p49 = (zext_ln56_fu_461_p1 + startIdx_reload);

assign zext_ln54_fu_578_p1 = i_2_reg_589;

assign zext_ln56_fu_461_p1 = ap_sig_allocacmp_i_2;

endmodule //binaryDivision_binaryDivision_Pipeline_VITIS_LOOP_54_7
