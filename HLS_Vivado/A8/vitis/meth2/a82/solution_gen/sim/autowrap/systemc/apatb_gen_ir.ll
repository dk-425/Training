; ModuleID = '/home/sam-admin/git/Training/HLS_Vivado/A8/vitis/meth2/a82/solution_gen/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_gen_ir(%"class.hls::stream<ComplexT, 0>"* noalias nocapture nonnull dereferenceable(8) %gst) local_unnamed_addr #1 {
entry:
  %gst_copy = alloca %"class.hls::stream<ComplexT, 0>", align 512
  call void @llvm.sideeffect() #7 [ "stream_interface"(%"class.hls::stream<ComplexT, 0>"* %gst_copy, i32 0) ]
  call fastcc void @copy_in(%"class.hls::stream<ComplexT, 0>"* nonnull %gst, %"class.hls::stream<ComplexT, 0>"* nonnull align 512 %gst_copy)
  call void @apatb_gen_hw(%"class.hls::stream<ComplexT, 0>"* %gst_copy)
  call void @copy_back(%"class.hls::stream<ComplexT, 0>"* %gst, %"class.hls::stream<ComplexT, 0>"* %gst_copy)
  ret void
}

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_in(%"class.hls::stream<ComplexT, 0>"* noalias, %"class.hls::stream<ComplexT, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #2 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @copy_out(%"class.hls::stream<ComplexT, 0>"* noalias, %"class.hls::stream<ComplexT, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #5 {
entry:
...
declare void @apatb_gen_hw(%"class.hls::stream<ComplexT, 0>"*)

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_back(%"class.hls::stream<ComplexT, 0>"* noalias, %"class.hls::stream<ComplexT, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #5 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ComplexT, 0>"(%"class.hls::stream<ComplexT, 0>"* %0, %"class.hls::stream<ComplexT, 0>"* align 512 %1)
  ret void
}

define void @gen_hw_stub_wrapper(%"class.hls::stream<ComplexT, 0>"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream<ComplexT, 0>"* null, %"class.hls::stream<ComplexT, 0>"* %0)
  call void @gen_hw_stub(%"class.hls::stream<ComplexT, 0>"* %0)
  call void @copy_in(%"class.hls::stream<ComplexT, 0>"* null, %"class.hls::stream<ComplexT, 0>"* %0)
  ret void
}

declare void @gen_hw_stub(%"class.hls::stream<ComplexT, 0>"*)
