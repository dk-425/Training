# ==============================================================
# File generated on Fri Mar 17 15:08:56 IST 2023
...
$(ObjDir)/a2_1_tb.c_pre.c.tb.o : a2_1_tb.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) a2_1_tb.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/a2_1.c_pre.c.tb.o : a2_1.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) a2_1.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
