...
`define TV_IN_b_V_TDATA "../tv/cdatafile/c.cal.autotvin_b_V.dat"
...
module AESL_axi_s_b_V (
    ...
    reg [8 - 1:0] b_V_TDATA_write_data;
    reg b_V_TDATA_read_en;
    wire [8 - 1:0] b_V_TDATA_read_data;
    
    fifo #(1, 8) fifo_b_V_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    assign TRAN_b_V_TVALID_temp = ~(b_V_TDATA_empty);
