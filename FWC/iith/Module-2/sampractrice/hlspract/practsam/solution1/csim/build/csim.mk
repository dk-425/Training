...
HLS_SOURCES = ../../../../pract_tb.cpp ../../../../pract.cpp
...
$(ObjDir)/pract_tb.o: ../../../../pract_tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../pract_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
...
-include $(ObjDir)/pract_tb.d

$(ObjDir)/pract.o: ../../../../pract.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../pract.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/pract.d
